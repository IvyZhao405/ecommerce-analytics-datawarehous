#!/bin/bash
# ods layer data warehouse initlizations, only needs to execute once.
...
location 'hdfs://localhost:9000/data/ods/user/';
...
row format delimited  
fields terminated by '\t'
location 'hdfs://localhost:9000/data/ods/user_extend/';
...
row format delimited  
fields terminated by '\t'
location 'hdfs://localhost:9000/data/ods/user_addr/';
...
row format delimited  
fields terminated by '\t'
location 'hdfs://localhost:9000/data/ods/goods_info/';
...
row format delimited  
fields terminated by '\t'
location 'hdfs://localhost:9000/data/ods/category_code/';
...
row format delimited  
fields terminated by '\t'
location 'hdfs://localhost:9000/data/ods/user_order/';
...
row format delimited  
fields terminated by '\t'
location 'hdfs://localhost:9000/data/ods/order_item/';
...
row format delimited  
fields terminated by '\t'
location 'hdfs://localhost:9000/data/ods/order_delivery/';
...
row format delimited  
fields terminated by '\t'
location 'hdfs://localhost:9000/data/ods/payment_flow/';
