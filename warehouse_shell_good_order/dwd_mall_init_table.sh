#!/bin/bash
# dwd layer data warehouse initlizations, only needs to execute once.
...
location 'hdfs://localhost:9000/data/dwd/user/';
...
row format delimited  
fields terminated by '\t'
location 'hdfs://localhost:9000/data/dwd/user_extend/';
...
row format delimited  
fields terminated by '\t'
location 'hdfs://localhost:9000/data/dwd/user_addr/';
...
row format delimited  
fields terminated by '\t'
location 'hdfs://localhost:9000/data/dwd/goods_info/';
...
row format delimited  
fields terminated by '\t'
location 'hdfs://localhost:9000/data/dwd/category_code/';
...
row format delimited  
fields terminated by '\t'
location 'hdfs://localhost:9000/data/dwd/user_order/';
...
row format delimited  
fields terminated by '\t'
location 'hdfs://localhost:9000/data/dwd/order_item/';
...
row format delimited  
fields terminated by '\t'
location 'hdfs://localhost:9000/data/dwd/order_delivery/';
...
row format delimited   
fields terminated by '\t'
location 'hdfs://localhost:9000/data/dwd/payment_flow/';
